package net.feral.fractureddepths.compat;
...
import net.feral.fractureddepths.recipe.GemPolishingRecipe;
import net.minecraft.network.chat.Component;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.world.item.ItemStack;

public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(FracturedDepths.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(FracturedDepths.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
    ...
    public Component getTitle() {
        return Component.translatable("block.fractureddepths.gem_polishing_station");
    }
