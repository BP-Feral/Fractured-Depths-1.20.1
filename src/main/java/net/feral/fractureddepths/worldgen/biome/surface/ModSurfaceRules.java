package net.feral.fractureddepths.worldgen.biome.surface;
...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.HOLLOWSHADE_FOREST_BIOME),
