package net.feral.fractureddepths.recipe;
...
public class GemPolishingRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<GemPolishingRecipe> {
        ...
        public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(FracturedDepths.MOD_ID, "gem_polishing");
